...
export async function sendMessage(
   ...
   try {
                  ...
                  parameters: [
                     {
                        type: 'image',
                        image: {
                           link: 'https://images.unsplash.com/photo-1721679241473-d00437cb5a44?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
                        },
                     },
                  ],
               },
      ...
      const response = await fetch(`https://graph.facebook.com/v20.0/${process.env.NEXT_PHONE_NUMBER_ID}/messages`, {
         method: 'POST',
         headers: headers,
         body: raw,
         redirect: 'follow',
