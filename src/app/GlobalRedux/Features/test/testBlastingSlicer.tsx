...
export const fetchLogs = createAsyncThunk('testBlasting/fetchLogs', async () => {
   const getToken = await fetch('/api/auth/session')
      .then((res) => res.json())
      .then((data) => {
         return data;
...
export const fetchInvitation = createAsyncThunk('testBlasting/fetchInvitation', async (clientId: string) => {
...
export const getDetailLogs = createAsyncThunk('testBlasting/getDetailLogs', async (clientId: string) => {
...
export const confirmInvitation = createAsyncThunk('testBlasting/confirmInvitation', async (data: any) => {
...
export const putAnswer = createAsyncThunk('testBlasting/putAnswer', async (data: any) => {
   const response = await fetch(`/api/test/invitation/${data.questionId}`, {
      method: 'PUT',
      body: JSON.stringify({
         questionId: data.questionId,
